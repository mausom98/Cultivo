...
var FabricControllerAdapter = (function (_super) {
    ...
    FabricControllerAdapter.prototype.query = function (controller, name, config) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, _super.prototype.query.apply(this, [controller + "_" + name, this.config.chaincode, config].concat(args))];
                    case 1:
                        txResult = _a.sent();
                        return [2, txResult.result];
                }

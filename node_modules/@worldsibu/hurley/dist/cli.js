...
var CLI = (function () {
    ...
    CLI.createNetwork = function (organizations, users, channels, path, inside) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        cli = new NetworkCLI();
                        return [4, cli.init(Number.parseInt(organizations), Number.parseInt(users), Number.parseInt(channels), path, inside)];
                    case 1:
                        _a.sent();
                        return [2, cli];
                }
...
var NetworkCLI = (function () {
    ...
    NetworkCLI.prototype.init = function (organizations, users, channels, path, inside) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                this.analytics.init();
    ...
    NetworkCLI.prototype.initNetwork = function (organizations, users, channels, path, insideDocker) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var homedir, _a, orgs, chs, usrs, config, cryptoConfig, dockerComposer, cryptoGenerator, networkRestart, binariesDownload;
            var _this = this;
    ...
    NetworkCLI.prototype.clean = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var networkClean;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        networkClean = new networkClean_sh_1.NetworkCleanShGenerator('clean.sh', 'na', null);

...
var tasks = {
    createNetwork: function (organizations, users, channels, path, inside) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, cli_1.CLI.createNetwork(organizations, users, channels, path, inside)];
    ...
    cleanNetwork: function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, cli_1.CLI.cleanNetwork()];
                    case 1: return [2, _a.sent()];
                }
            });
        });
...
program
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!cmd) return [3, 2];
                return [4, tasks.createNetwork(!cmd.organizations || (cmd.organizations <= 2) ? 2 : cmd.organizations, !cmd.users || (cmd.users <= 1) ? 1 : cmd.users, !cmd.channels || (cmd.channels <= 1) ? 1 : cmd.channels, cmd.path, !!cmd.inside)];
            case 1:
                _a.sent();
                return [3, 4];
...
program
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, tasks.cleanNetwork()];
            case 1:
                _a.sent();
                return [2];
        }
